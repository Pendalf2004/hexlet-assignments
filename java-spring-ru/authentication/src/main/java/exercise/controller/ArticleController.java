...
public class ArticleController {
    ...
    public ArticleDTO create(@RequestBody @Valid ArticleCreateDTO createData) {
        var createdArticle = articleMapper.map(createData);
        createdArticle.setAuthor(userUtils.getCurrentUser());
